...
export function Contacto() {
    ...
    const items = [
        ...
        {label: labels.github, value: contactInfo.MainGithub, href: `https://github.com/${contactInfo.MainGithub}`},
        {label: labels.github, value: contactInfo.SecondaryGithub, href: `https://github.com/${contactInfo.MainGithub}`
        },
    ]
